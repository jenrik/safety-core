...
All changes must be accompanied by a set of unit tests and property tests, and before finalizing it must pass an adversarial review by a frontier model.
