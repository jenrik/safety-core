...
export const STRICT_ALLOWED_FLAGS: Readonly<Record<string, readonly AllowedFlag[]>> = {
  kubectl: [{ long: "--namespace", short: "-n", takesValue: true }, { long: "--context", takesValue: true }, { long: "--output", short: "-o", takesValue: true }],
  oc: [{ long: "--namespace", short: "-n", takesValue: true }, { long: "--context", takesValue: true }, { long: "--output", short: "-o", takesValue: true }],
