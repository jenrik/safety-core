...
export const BUILTINS_V1: Readonly<Record<string, BuiltinDefinition>> = Object.freeze({
  ...
  repositoryHasExplicitHost: builtin(["repository"], "bool", "O(1)", "Whether a parsed repository target included an explicit host component."),
  repositoryMatches: builtin(["repository", "string", "string", "string"], "bool", "O(n)", "Exact host, owner, and repository comparison against finite literals."),
  repositoryMatchesOrganization: builtin(["repository", "string", "string"], "bool", "O(n)", "Exact host and owner comparison against a finite organization literal."),
  ...
  hasAnyAssignment: builtin([], "bool", "O(1)", "Whether an invocation has one or more leading assignments."),
  assignmentsAreSubset: builtin(["string-set"], "bool", "O(as)", "Whether every leading assignment name belongs to a finite literal allowlist."),
